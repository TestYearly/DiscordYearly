...
export default function Footer() {
  return (
    <footer className="py-10 px-6 bg-discord-darkest border-t border-gray-800">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-6 md:mb-0">
            ...
            <span className="font-bold text-lg">Discord Wrapped</span>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>Not affiliated with Discord Inc. Made with 💜 by developers for the Discord community.</p>
          <p className="mt-2">© {new Date().getFullYear()} Discord Wrapped</p>
        </div>
      </div>
    </footer>
  );
